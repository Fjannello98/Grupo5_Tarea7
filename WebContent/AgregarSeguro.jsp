...
<body>
	...
	<form method="get">
		...
		<label for="txtCostoMaxContratacion" style="margin-right:10px;">Costo máximo de contratación</label><input type="text" id="txtCostoMaxContratacion" name="txtCostoMaxContratacion"><br>	
